...
def build_embed(region: str, game_name: str, tag_line: str, mmr_payload: dict, mmrh_payload: dict, acct_payload: dict) -> discord.Embed:
    ...
    highest_rank = current.get("highest_tier_patched") or "Nush e grele cu d-astea"
    ...
    e.add_field(name="Highest Rank", value=str(highest_rank) if highest_rank is not None else "N/A", inline=True)  
